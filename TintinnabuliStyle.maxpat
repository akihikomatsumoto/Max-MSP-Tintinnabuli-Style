{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 205.0, 797.0, 502.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 205.0, 797.0, 502.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "delay 10",
					"numinlets" : 2,
					"patching_rect" : [ 405.0, 75.0, 56.0, 20.0 ],
					"id" : "obj-52",
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 315.0, 360.0, 20.0, 20.0 ],
					"id" : "obj-43",
					"numoutlets" : 1,
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "!= 0",
					"numinlets" : 2,
					"patching_rect" : [ 420.0, 405.0, 32.5, 20.0 ],
					"id" : "obj-7",
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"text" : "delay 1",
					"numinlets" : 2,
					"patching_rect" : [ 420.0, 495.0, 49.0, 20.0 ],
					"id" : "obj-38",
					"numoutlets" : 1,
					"fontname" : "Arial",
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"numinlets" : 1,
					"patching_rect" : [ 420.0, 465.0, 20.0, 20.0 ],
					"id" : "obj-31",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sel 0",
					"numinlets" : 2,
					"patching_rect" : [ 420.0, 435.0, 36.0, 20.0 ],
					"id" : "obj-63",
					"numoutlets" : 2,
					"fontname" : "Arial",
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					...
					"hilite" : 0,
					"numinlets" : 1,
					"patching_rect" : [ 600.0, 525.0, 152.0, 24.0 ],
					"presentation" : 1,
					"id" : "obj-48",
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 2,
					"patching_rect" : [ 302.0, 523.5, 282.0, 26.0 ],
					"id" : "obj-50",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 600.0, 525.0, 148.0, 23.0 ],
					"presentation" : 1,
					"id" : "obj-51",
					"numoutlets" : 0,
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 99.5, 171.0, 75.0, 171.0, 75.0, 72.0, 414.5, 72.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 414.5, 105.0, 489.5, 105.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 624.5, 330.0, 294.5, 330.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 489.5, 231.0, 450.0, 231.0, 450.0, 330.0, 429.5, 330.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 99.5, 360.0, 255.0, 360.0, 255.0, 342.0, 443.0, 342.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 429.5, 516.0, 405.0, 516.0, 405.0, 330.0, 465.0, 330.0, 465.0, 117.0, 489.5, 117.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 429.5, 426.0, 396.0, 426.0, 396.0, 357.0, 324.5, 357.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 99.5, 261.0, 75.0, 261.0, 75.0, 360.0, 255.0, 360.0, 255.0, 330.0, 465.0, 330.0, 465.0, 237.0, 489.5, 237.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 579.5, 330.0, 345.0, 330.0, 345.0, 390.0, 303.0, 390.0, 303.0, 387.0, 293.0, 387.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-59", 1 ],
					"hidden" : 0,
					"midpoints" : [ 534.5, 330.0, 345.0, 330.0, 345.0, 390.0, 303.0, 390.0, 303.0, 387.0, 293.0, 387.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-59", 1 ],
					"hidden" : 0,
					"midpoints" : [ 489.5, 330.0, 345.0, 330.0, 345.0, 390.0, 303.0, 390.0, 303.0, 387.0, 293.0, 387.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 190.5, 456.0, 405.0, 456.0, 405.0, 330.0, 450.0, 330.0, 450.0, 117.0, 414.5, 117.0 ]
				}
